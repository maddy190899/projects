...
import { ArrowUpRight, Award, Filter } from 'lucide-react';
            ...
            >
              ...
              <div className="relative aspect-[16/10] overflow-hidden bg-canvas-muted">
                ...
                <div className="absolute top-4 left-4 flex gap-2">
                  <span className="px-3 py-1 rounded-full bg-white/95 backdrop-blur-md border border-black/10 text-xs font-mono text-text-primary font-medium shadow-luxury-sm">
                    {project.category}
                  </span>
